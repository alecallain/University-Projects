...
public class GeyserGUI extends JFrame implements ActionListener{
    ...
    public GeyserGUI(){
        ...
        leastActive = new JButton("Least Active");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (e.getSource() == geyserList) {
            ...
            resultsArea.setText(temp.toString() + "\n" + db.getNumGeysers() + " geysers");
        }
        ...
        if (e.getSource() == byName) {
            if (geyser.getText().length() == 0) {
                ...
                for (int i = 0; i <= list.size()-1; i++) {
                    temp2 = list.get(i).toString();
                }
                resultsArea.setText(temp2 + list.size() + " eruptions");
            }
        }
        ...
        if (e.getSource() == numOnDay ) {
            ...
            if ((numMonth >=1 && numMonth <= 12) && (numDay >= 1 && numDay <= 31) && (numYear == 2010)) {
                resultsArea.setText(db.getNumEruptions() + " eruptions on " + numMonth + "/" + numDay + "/" + numYear);
            }
